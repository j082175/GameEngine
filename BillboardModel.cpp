...
void BillboardModel::Initialize(ComPtr<ID3D11Device> &device,
    ...
    m_pixelShader = Graphics::billboardPS;
    ...
    D3D11Utils::CreateTextureArray(device, context, filePath, m_textureArray,
...
void BillboardModel::Render(ComPtr<ID3D11DeviceContext> &context) {
     ...
     //    context->VSSetConstantBuffers(3, 1,
     //    m_billboardConsts.GetAddressOf()); context->PSSetConstantBuffers(3,
     //    1, m_billboardConsts.GetAddressOf());
     //    context->GSSetConstantBuffers(3, 1,
     //    m_billboardConsts.GetAddressOf());
